              ...
              <?php foreach ($karyawan as $m) : ?>
                <tr>
                  ...
                  <td style="text-align: center">
                    ...
                    <button id="update" data-toggle="modal" data-target="#modal-item-update" class="badge badge-primary" data-kode="<?= $m['kode'] ?>" data-nama="<?= $m['nama'] ?>" data-email="<?= $m['email'] ?>" data-nik="<?= $m['nik'] ?>" data-ttl="<?= $m['ttl'] ?>" data-ttl="<?= $m['tgl'] ?>" data-jabatan="<?= $m['jabatan'] ?>" data-divisi="<?= $m['divisi'] ?>" data-alamat="<?= $m['alamat'] ?>" data-telp="<?= $m['telp'] ?>">
        ...
        <form action="<?= base_url('karyawan/add'); ?>" method="post">
          <div class="modal-body">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="pendidikan" name="pendidikan" placeholder="pendidikan Terakhir" required="" autocomplete="off"><br>
